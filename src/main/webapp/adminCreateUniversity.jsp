...
<div id="page-wrapper">
    ...
    <section id="header">
        ...
        <nav id="nav">
            ...
            <ul>
                ...
                <li><a href="${pageContext.request.contextPath}/admin/editInformation"><fmt:message
                        key="label.edit"/></a></li>
                <li class="current"><a href="${pageContext.request.contextPath}/admin/createUniversity"><fmt:message
                        key="label.create"/></a></li>
            </ul>
        </nav>
    </section>
    ...
    <section id="main">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <form method="post" action="${pageContext.request.contextPath}/adminCreateUniversityButton">
                        <section>
                            <header class="major">
                            ...
                            <div>
                                ...
                                <label>
                                    <input type="text" required placeholder="<fmt:message key="label.information"/>" name="information">
                                </label>
                                <label>
