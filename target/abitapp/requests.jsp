    ...
    <section id="header">
        ...
        <nav id="nav">
            ...
            <ul>
                ...
                <li class="current"><a href="${pageContext.request.contextPath}/profile/requests"><fmt:message key="label.request"/></a></li>
        ...
        <c:choose>
            <c:when test="${sessionScope.user.requestSpecialty != null}">
                <header class="major">
                    <h2><fmt:message key="label.yourАpplicationIs"/> ${sessionScope.user.requestSpecialty.name}(<fmt:message key="label.formOfTraining"/> - <fmt:message key="label.formOfTraining${sessionScope.user.formOfTraining}" />)</h2>
                </header>
                <div>
            ...
            <c:when test="${sessionScope.user.specialty != null}">
                <header class="major">
                    <h2 style="color: forestgreen"><fmt:message key="label.yourАpplicationIs"/> ${sessionScope.user.specialty.name} <fmt:message key="label.accepted"/></h2>
                </header>
                <header class="major">
                    <h2><fmt:message key="label.formOfTraining"/> - <fmt:message key="label.formOfTraining${sessionScope.user.formOfTraining}" /></h2>
                </header>
                <div>
                    <header class="button">
                        <a href="${pageContext.request.contextPath}/profile/rating"><fmt:message key="label.viewRating"/> </a>
                    </header>
                </div>
            </c:when>
            <c:otherwise>
...
<c:if test="${sessionScope.user.formOfTraining == 0}">
    <header class="major">
        <h2>Рейтинг -
    </header>
</c:if>
...
<div style="text-align: center;">
            <span>
                ...
                <c:forEach var="exam" items="${sessionScope.user.examMarks}">
                    ...
                    <header class="button alt">
                        <p> ${exam.key} - ${exam.value} </p>
                    </header>
                </c:forEach>
                <header class="button">
                    <p>SUMMA ${sumOfMarks}</p>
                </header>
            </span>
</div>
</section>
